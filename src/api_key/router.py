...
async def create_api_key(
    ...
    """
    return await ApiKeyService(db, tenant_id).create(
        name=body.name,
...
async def list_api_keys(
    ...
    """API 키 목록(활성만)."""
    return await ApiKeyService(db, tenant_id).list_by_tenant()
...
async def get_api_key(
    ...
    """API 키 단건 조회(활성만)."""
    return await ApiKeyService(db, tenant_id).get(api_key_id)
...
async def update_api_key(
    ...
    return await ApiKeyService(db, tenant_id).update(
        api_key_id,
        name=body.name,
        description=body.description,
...
async def revoke_api_key(
    ...
    await ApiKeyService(db, tenant_id).revoke(api_key_id, actor_user_id=int(me.id))
