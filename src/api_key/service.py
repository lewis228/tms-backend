...
# "omniq_" + 43 url-safe chars ≈ 256 bits of entropy; matches Stripe-style keys.
KEY_PREFIX_LITERAL = "omniq_"
...
class ApiKeyService:
    """팀 scoped API Key 서비스. 생성자에서 ``team_id`` 를 받는다."""
    ...
    async def create(
        ...
        *,
        ...
        team = await self.team_repo.get_team_by_id(self.team_id)
        if team is None:
