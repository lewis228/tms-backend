...
async def create_driver(
    ...
    - 쓰기 권한 필요
    """
    return await DriverService(db, tenant_id).create(
        body,
...
async def list_drivers(
    ...
    """
    return await DriverService(db, tenant_id).list_paginated(request)
...
async def sync_drivers(
    ...
    """
    return await DriverService(db, tenant_id).sync_delta(since)
...
async def get_driver(
    ...
    거래처 단건 조회(활성만)
    """
    return await DriverService(db, tenant_id).get(driver_id)
...
async def update_driver(
    ...
    - 쓰기 권한 필요
    """
    return await DriverService(db, tenant_id).update(
        driver_id,
        body,
        actor_user_id=int(me.id),
    )
...
async def delete_driver(
    ...
    """
    return await DriverService(db, tenant_id).delete(
        driver_id,
        actor_user_id=int(me.id),
    )
...
async def create_drivers_bulk(
    ...
    - 부분 성공 허용
    """
    return await DriverService(db, tenant_id).create_bulk(
        body,
        actor_user_id=int(me.id),
    )
...
async def update_drivers_bulk(
    ...
    - 존재하지 않는 ID는 실패 처리
    """
    return await DriverService(db, tenant_id).update_bulk(
        body,
        actor_user_id=int(me.id),
    )
...
async def delete_drivers_bulk(
    ...
    """
    return await DriverService(db, tenant_id).delete_bulk(
        body,
        actor_user_id=int(me.id),
    )